...
public class AgentOrchestrator {
    ...
    public Employee orchestrateFindEmployee(String skillName, Map<String, String> variables) throws Exception {
        String template = skillLoader.loadSkill(skillName);
        ...
        Employee employeeCriteria = objectMapper.readValue(json, Employee.class);
        log.info("Orchestrator parsed employee criteria: {} {}", employeeCriteria.getFirstName(), employeeCriteria.getLastName());
